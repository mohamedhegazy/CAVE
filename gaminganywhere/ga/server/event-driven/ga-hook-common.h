...
extern int vsource_d_initialized;
...
extern dpipe_t *g_pipe[SOURCES];//frame buffer from capturer to encoder
extern dpipe_t *g_pipe_d[SOURCES];//depth buffer from capturer to RC module
