...
//	snprintf(buf2, sizeof(buf2), "%s%s", ga_root, "renderdoc.dll");
//	if(MultiByteToWideChar(CP_UTF8, 0, buf2, -1, dllpath_w2, sizeof(dllpath_w2)/sizeof(wchar_t)) <= 0) {
//		fprintf(stderr, "error converting dllpath to wchar_t.\n");
//		return -1;
//	}
//	fwprintf(stderr, L"dllpath: %s\n", dllpath_w2);
//	r = RhInjectLibrary(pid, /* command */
...
//			NULL, 0		/* passthrough buffer and size */);
//	if(r != 0) {
//		fprintf(stderr, "RenderDoc Injection Failed, err=%08x.\n", r);
//	}
