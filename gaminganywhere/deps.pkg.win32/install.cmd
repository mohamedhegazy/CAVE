...
@REM bin\7za x x264-20140330-2245.zip
bin\7za x x265.zip
move /y x265\x86\include\*.h %GADEPS%\include\
move /y x265\x86\bin\*.exe %GADEPS%\bin\
move /y x265\x86\bin\*.dll %GADEPS%\bin\
move /y x265\x86\lib\*.lib %GADEPS%\lib\
rmdir /s /q x265
bin\7za x OpenCL.zip
move /y OpenCL\x86\include\CL %GADEPS%\include\
move /y OpenCL\x86\bin\*.* %GADEPS%\bin\
move /y OpenCL\x86\lib\*.lib %GADEPS%\lib\
rmdir /s /q OpenCL
